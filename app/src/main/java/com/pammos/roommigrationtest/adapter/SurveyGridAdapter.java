...
public class SurveyGridAdapter extends RecyclerView.Adapter<SurveyGridAdapter.SurveyCellViewHolder> {
    ...
    public SurveyGridAdapter(@NonNull Context context) {
    ...
    @NonNull
    @Override
    public SurveyCellViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemView = inflater.inflate(R.layout.card_view_survey_row_item, parent,
                false);

        return new SurveyGridAdapter.SurveyCellViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SurveyCellViewHolder holder, int position) {
    ...
    public class SurveyCellViewHolder extends RecyclerView.ViewHolder {
        ...
        public SurveyCellViewHolder(@NonNull View itemView) {
